...
@Introspected
public class Handler extends MicronautRequestHandler<S3EventNotification, Void> {

    private static final Logger LOG = LoggerFactory.getLogger(Handler.class);
    private static final String SLASH = "/";
    private static final String THUMBNAILS = "thumbnails";
    private static final String OBJECT_CREATED = "ObjectCreated";
    ...
    @Override
    public Void execute(final S3EventNotification input) {
    ...
    private static String thumbnailKey(final String key) {
